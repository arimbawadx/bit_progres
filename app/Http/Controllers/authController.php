...
class authController extends Controller
{
    ...
    {
       $CustomerServices=CustomerServices::where('username', $request->username)->first();
       $Customers=Customers::where('username', $request->username)->first();
       $Programmers=Programmers::where('username', $request->username)->first();
